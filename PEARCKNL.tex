...
\caption{Run time of linear solve kernel for large matrix.}
...
%Strong scaling results for $N=20000$ are given in Figure~\ref{fig:crossMatmatScale}.
\begin{figure}
...
We tested the QR decomposition kernel which calls the LAPACK \texttt{dgeqp3}
  routine.
...
The singular value decomposition (SVD) kernel exhibited similar performance
...
%Strong scaling results for the QR and singular value decompositions with
%  $N=20000$ are given in Figure~\ref{fig:crossMatmatScale}.
%\begin{figure}
%\includegraphics[height=\columnwidth, width=\columnwidth]{qr_svd_20000_68-rt.pdf}
%\caption{Run time of QR decomposition and SVD kernels.}
%\label{fig:qrSvdTime}
%\end{figure}
