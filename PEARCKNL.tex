...
% TODO: We need an introductory paragraph to
% introduce the overall purpose of what is going to be a large section.
...
% JRM - The sentence below indicates a goal not explicitly stated in the
...
% JRM - This sentence was redundant; removed.
...
% JRM - Might want to merge this paragraph with the opening section paragraph
% and make the resulting paragraph more concise.
...
Programs executed with \texttt{numactl} will allocate as much memory from
  MCDRAM as is available; any additional memory needed by the program will be
